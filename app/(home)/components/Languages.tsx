  ...
  return (
    <div>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 m-20'>
        ...
        <MovingBorderBtn className='p-10 text-xl font-bold italic'><Link href={"https://drive.google.com/file/d/12BF52dy2Kp4SnfUPdLxV6A51HOwjGATg/view?usp=sharing"} target="_blank">Japanese (JLPT N3)</Link></MovingBorderBtn>
      </div>
    </div>
  )
}
